...
### Minimal risk equivariant estimator
...
- If $\delta(X)$ is location equivariant, then its bias $b$ is constant
and $\delta(X)-b$ has smaller risk.
- The minimal risk equivariant estimator is unbiased.
- If UMVUE exists and is location equivariant, then the MREE and UMVUE
coincide.
